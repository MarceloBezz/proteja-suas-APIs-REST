...
public class RespostaController {
    ...
    @PutMapping
    public ResponseEntity<DadosListagemResposta> atualizar(@RequestBody @Valid DadosAtualizacaoResposta dados, Usuario logado) {
    ...
    @DeleteMapping("/{id}")
    public ResponseEntity<Void> excluir(@PathVariable Long id, Usuario logado) {
